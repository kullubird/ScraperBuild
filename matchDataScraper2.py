...
listNewMatchIds=open("Scraped Data/"+str(region)+"/newMatchIds"+str(capsRegion)+".txt").read().splitlines()
listDoneMatchIds=open("Scraped Data/"+str(region)+"/doneMatchIds"+str(capsRegion)+".txt").read().splitlines()
